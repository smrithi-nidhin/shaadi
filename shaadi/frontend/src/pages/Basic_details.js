...
class Basic_details extends React.Component {
    state = {
      ...
      //event.preventDefault();
        ...
        Shaadi.registration1(usname, dob,martial_status, height,weight,disability, blood, religion, mother_tongue,
            community,sub_community,fatherStatus,motherStatus,family_location,native_place,
            family_type,family_values,diet,highest_qualification,college_attened,working_with,
            working_as,annual_income,age,martial_status1,height1,religion1,
        ...
        <div className="container">
                  ...
                  <span className="sr-only">Toggle navigation</span>
                        ...
                        <ul className="nav navbar-nav nav_1">
                            ...
                            {/* <li className="last"><a href={this.btnclickprofile}  onClick={this.btnclickprofile} style={{fontSize:'20px',color:'white'}}>Profile</a></li> */}
                           
                            <li className="last"><a href={this.btnclickhome}  onClick={this.btnclickhome} style={{fontSize:'20px',color:'white'}}>Logout</a></li>
                          </ul>
                        </div>
                      </nav>
                    </div>
                  ...
                  <div ><h1 style={{color:"white",paddingTop:"100px"}}>Let's create your Profile now  <br></br>
...
<div className="row" style={{border:'none',marginBottom:'20px'}}>       
            ...
            <Formik
              ...
              {({ errors, touched }) => (
                <Form>
                  ...
                  <div className="col-md-6" style={{padding:'30px',backgroundColor:'#f1eff1',marginTop:'10px'}}> 
                  ...
                  <div className="agileits">
                    ...
                    <div className="agileits">
                      <label><span style={{ color: 'red', fontWeight: 100 }}>*</span>Any Disability :</label><br></br>
                      <Field 
                  type="radio"
                  value="none"
                ...
                <div className="agileits">
                  ...
                  <h1>Family</h1>
                   ...
                   <div className="agileits">
                    ...
                    <div className="agileits">
                      <label><span style={{ color: 'red', fontWeight: 100 }}>*</span>Family Type:</label><br></br>
                      <Field 
                  type="radio"
                  value="joint"
                ...
                />Nuclear
                    ...
                    <div className="agileits">
                      <label><span style={{ color: 'red', fontWeight: 100 }}>*</span>Family values:</label><br></br>
                      <Field 
                  type="radio"
                  value="traditional"
                ...
                />Liberal
                  ...
                  <div className="agileits">
                    <label><span style={{ color: 'red', fontWeight: 100 }}>*</span>Diet:</label><br></br>
                    <Field 
                type="radio"
                value="veg"
 ...
 <div className="agileits">
                  ...
                  <div className="w3_submit">
                    <button type="submit" className="btn btn-success" style={{width:"300px",height:"40px",backgroundColor:' #00c4da'}}> Create Profile</button>
                  </div>
                </Form>
              )}
            </Formik>
